 ...
 * 
 */
@WebServiceClient(name = "WebServiceService", targetNamespace = "http://example/", wsdlLocation = "http://localhost:8080/services/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICESERVICE_QNAME = new QName("http://example/", "WebServiceService");
    ...
    public WebService getWebServicePort() {
        return super.getPort(new QName("http://example/", "WebServicePort"), WebService.class);
    }
    ...
    public WebService getWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://example/", "WebServicePort"), WebService.class, features);
    }
